...
from .models import BinanceAccount, BinanceFuturesAccount, SpotBalance, FutureBalance, BinanceOrder, BinanceSymbolSettings, BinanceFuturePosition
from binance.client import Client
from binance.exceptions import BinanceAPIException
from decimal import Decimal
from binance.client import Client
from django.conf import settings
from .serializers import BinanceAccountSerializer, BinanceAccountSerializer, BinanceFuturesAccountSerializer, \
    BinanceOrderSerializer, BinanceSymbolSettingsSerializer
...
#                 )
#
#             return Response({"message": "Periodic task has been set up or updated."}, status=status.HTTP_200_OK)
