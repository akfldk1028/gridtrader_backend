...
12.  **IMPORTANT** :You should check all the given time frames together. In particular, we review data every one-hours so focusing on the 2-hour time frame, 1-hour time frame. and 15-minute time frame, and refer to the 1-day time frame.  Make a close and quick judgment.
