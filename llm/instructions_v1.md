...
- **Contents**:
      - 15m, 2h, 1d: Represents support and resistance levels for 15-minutes, 2-hour and 1-day  intervals respectively.
...
12.  **IMPORTANT** :You should check all the given time frames together. In particular, we review data every one-hours so focusing on the 2-hour time frame and 15-minute time frame, and refer to the 1-day time frame.  Make a close and quick judgment.
- Be careful, you shouldn't completely trust the long frame because there is a lot of volatility within a day. You should look at the short frame appropriately.
