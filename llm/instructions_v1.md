...
11. **IMPORTANT** :You should check all the given time frames together. In particular, use the weekly timeframe as a reference only and focus on the 2-hour and daily timeframes.
