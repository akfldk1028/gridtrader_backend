...
def perform_analysis():
       ...
       **Guidelines:**  
        ...
        **Output Format:**
        ...
        End your response with three lines indicating the predicted direction and confidence level for each timeframe:
             ...
             "8-24 hours: [Up/Down/Neutral] [Confidence]% | Target Range: $[Low] - $[High]"
    ...
    # expected_output = """A concise explanation of the grid trading strategy, including trend analysis with focus on sharp movements in both directions (with slight upward bias), key Ichimoku insights, balanced long/short approach, and the final strategy selection with a clear rationale , followed by the chosen strategy:  ('RegularGrid', 'ShortGrid', or 'LongGrid')"""
    ...
    korean_summary_task = Task(
        ...
        **Additionally, include a summary of the Ichimoku Cloud analysis based on the data from the 30-minute, 1-hourly, 2-hourly, and 6-hourly analyses.**
